      ...
      <div className="history-con">
        ...
        <div className="content-his">
          <div className="left-his">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint rerum
              dolorem, aperiam molestias fuga corporis itaque, deleniti odit ratione
              numquam vero voluptatum recusandae quidem culpa nobis voluptas?</p>
          </div>
