...
export default function PopupProvider({
  ...
  return (
    <PopupContext.Provider value={{ notify }}>
      <div
        className="fixed bottom-0 left-[50%] translate-x-[-50%] z-[100] translate-y-[-2rem] text-body bg-white px-12 py-3 rounded-md font-body shadow-lg shadow-main/30 transition-all duration-500 max-md:w-[calc(100vw-1.5rem)] max-md:px-4 max-md:text-center"
        style={{
